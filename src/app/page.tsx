...
export default async function Page() {
  ...
  return <div className="w-full h-[100vh] bg-black flex justify-center items-center flex-col gap-5">
    <h2 className=" absolute top-10 left-1/2 -translate-x-1/2 text-4xl text-white font-semibold">Expense Tracker</h2>
    ...
    {data && data.map(function ({ id, name, amount }: any) {
      // console.log(id);
      return <div key={id} className="rounded-sm border border-white px-2 py-2 w-90 text-white flex justify-between items-center gap-2">
